...
export function createCurrentScenario(
  ...
  return {
    ...
    employment: "Current household income",
    ...
    earners: 1,
    color: "#f6b44f",
    spouseJob: "Add a note if relevant",
    childcare: "Add a note if relevant",
    transport: "Add a note if relevant",
    residency: "Current home base",
    bonus: "Not included unless converted into recurring monthly inputs.",
    benefits: [],
    risks: [],
  };
}
...
export function createBlankScenario(
  ...
  return {
    ...
    label: "New option",
    location: "City · country",
    employment: "Income included in this option",
    status: "Planning",
    currency: document.baseCurrency,
    ...
    earners: 1,
    color: "#b997ff",
    spouseJob: "Not assessed",
    childcare: "Not assessed",
    transport: "Not assessed",
    residency: "Not assessed",
    bonus: "Not included until converted into recurring monthly inputs.",
    benefits: [],
    risks: [],
  };
}
